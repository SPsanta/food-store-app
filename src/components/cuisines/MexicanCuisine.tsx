...
export const MexicanCuisine: React.FC<MexicanCuisineProps> = ({ onBack }) => {
  ...
  const mexicanDishes: Dish[] = [
    {
      id: '1',
      name: 'Тако Карне Асада',
      description: 'Тако с жареной говядиной, луком и кинзой',
      image: 'https://images.pexels.com/photos/825661/pexels-photo-825661.jpeg',
      price: 850,
      cookTime: '20 мин',
      rating: 4.8,
      tags: ['тако', 'говядина', 'лук'],
      chef: {
        name: 'Карлос Мендес',
    ...
    },
    {
      id: '2',
      name: 'Гуакамоле',
      description: 'Авокадо с томатами, луком и лаймом',
      image: 'https://images.pexels.com/photos/2097090/pexels-photo-2097090.jpeg',
      price: 450,
      cookTime: '10 мин',
      rating: 4.6,
      tags: ['авокадо', 'томаты', 'лайм'],
      chef: {
        name: 'Мария Гонсалес',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face',
        speciality: 'Гуакамоле',
        rating: 4.6
      }
    },
    {
      id: '3',
      name: 'Энчиладас',
      description: 'Тортильи с курицей, сыром и соусом',
      image: 'https://images.pexels.com/photos/1437267/pexels-photo-1437267.jpeg',
      price: 1200,
      cookTime: '25 мин',
      rating: 4.7,
      tags: ['тортильи', 'курица', 'сыр'],
      chef: {
        name: 'Хуан Родригес',
        avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
        speciality: 'Энчиладас',
        rating: 4.7
      }
    },
    {
      id: '4',
      name: 'Кесадилья',
      description: 'Тортилья с сыром и овощами',
      image: 'https://images.pexels.com/photos/825661/pexels-photo-825661.jpeg',
      price: 750,
      cookTime: '15 мин',
      rating: 4.5,
      tags: ['тортилья', 'сыр', 'овощи'],
      chef: {
        name: 'Ана Лопес',
        avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face',
        speciality: 'Кесадилья',
        rating: 4.5
      }
    },
    {
      id: '5',
      name: 'Чили Кон Карне',
      description: 'Острое блюдо с говядиной и фасолью',
      image: 'https://images.pexels.com/photos/699953/pexels-photo-699953.jpeg',
      price: 1100,
      cookTime: '45 мин',
      rating: 4.8,
      tags: ['говядина', 'фасоль', 'острый'],
      chef: {
        name: 'Роберто Санчес',
    ...
    },
    {
      id: '6',
      name: 'Буррито',
      description: 'Тортилья с рисом, фасолью и мясом',
      image: 'https://images.pexels.com/photos/723198/pexels-photo-723198.jpeg',
      price: 950,
      cookTime: '20 мин',
      rating: 4.6,
      tags: ['тортилья', 'рис', 'фасоль'],
      chef: {
        name: 'Луис Флорес',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face',
        speciality: 'Буррито',
    ...
    },
    {
      id: '8',
      name: 'Начос',
      description: 'Чипсы с сыром, гуакамоле и сметаной',
      image: 'https://images.pexels.com/photos/2097090/pexels-photo-2097090.jpeg',
      price: 650,
      cookTime: '12 мин',
      rating: 4.4,
      tags: ['чипсы', 'сыр', 'гуакамоле'],
      chef: {
        name: 'Патрисия Васкес',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face',
        speciality: 'Начос',
        rating: 4.4
      }
    },
    {
      id: '9',
      name: 'Тамалес',
      description: 'Кукурузные листья с начинкой из мяса',
      image: 'https://images.pexels.com/photos/1437267/pexels-photo-1437267.jpeg',
      price: 850,
      cookTime: '60 мин',
      rating: 4.5,
      tags: ['кукуруза', 'мясо', 'листья'],
      chef: {
        name: 'Габриэла Эрнандес',
        avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
        speciality: 'Тамалес',
        rating: 4.5
      }
    },
    {
      id: '10',
      name: 'Флаут',
      description: 'Мексиканский десерт с карамелью',
      image: 'https://images.pexels.com/photos/3071821/pexels-photo-3071821.jpeg',
      price: 550,
      cookTime: '15 мин',
      rating: 4.3,
      tags: ['десерт', 'карамель', 'сладкий'],
      chef: {
        name: 'Кармен Руис',
        avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face',
        speciality: 'Десерты',
  ...
  const handleSwipe = (direction: 'left' | 'right') => {
    ...
    setTimeout(() => {
      ...
      if (direction === 'right') {
        setCurrentDishIndex(prev => Math.min(prev + 1, mexicanDishes.length - 1));
      } else {
        setCurrentDishIndex(prev => Math.min(prev + 1, mexicanDishes.length - 1));
      }
    }, 300);
  ...
  const handleShowDetails = () => {
    console.log('Показать детали:', mexicanDishes[currentDishIndex]);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-yellow-50 to-red-50">
      {/* Header */}
